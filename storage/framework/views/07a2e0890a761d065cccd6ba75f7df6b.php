...
<?php endif; ?>
<?php $component->withAttributes(['size' => 'xl']); ?>Управление пользователями <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-800">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <div class="font-medium text-gray-900 dark:text-gray-100"><?php echo e($user->name); ?></div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-gray-100"><?php echo e($user->email); ?></td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex flex-wrap gap-1">
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                                        ...
                                                        <td class="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-gray-100"><?php echo e(\App\Helpers\Settings::formatDateTime($user->created_at)); ?></td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('users.edit')): ?>
                                    <button wire:click="edit(<?php echo e($user->id); ?>)" class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300">
                                        Редактировать
                                    </button>
                                <?php endif; ?>
                ...
                <div class="border-b border-gray-200 dark:border-gray-700 p-4 hover:bg-gray-50 dark:hover:bg-gray-800">
                    ...
                    <div class="flex items-center justify-between pt-2 border-t border-gray-100 dark:border-gray-600">
                        <div class="text-xs text-gray-500 dark:text-gray-400">
                            Создан: <?php echo e(\App\Helpers\Settings::formatDate($user->created_at)); ?>

                        </div>
                        <div class="flex space-x-3">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('users.edit')): ?>
                                <button wire:click="edit(<?php echo e($user->id); ?>)" class="text-sm text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300">
                                    Редактировать
                                </button>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('users.delete')): ?>
                    ...
                    <div class="space-y-6">
                        <div>
                            <h3 class="text-lg font-medium leading-6 text-gray-900 dark:text-gray-100">
                                <?php echo e($editingUser ? 'Редактировать пользователя' : 'Создать пользователя'); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                    Пароль <?php echo e($editingUser ? '(оставьте пустым для сохранения текущего)' : '*'); ?>
                                ...
                                <div class="space-y-2">
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="flex items-center">
                                            ...
                                            <span class="ml-2 text-sm text-gray-700 dark:text-gray-300"><?php echo e($role->name); ?></span>
                                        </label>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                </div>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="flex justify-end space-x-3">
                            ...
                            <button type="submit" 
                                class="px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                <?php echo e($editingUser ? 'Обновить' : 'Создать'); ?>
...
<?php /**PATH H:\OSPanel\home\crm-starter.kit\resources\views/livewire/admin/users/user-manager.blade.php ENDPATH**/ ?>