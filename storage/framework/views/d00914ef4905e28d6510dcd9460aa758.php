<div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-4 lg:p-6">
                ...
                <div class="mb-6">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($cashRegisters && $cashRegisters->count() > 0): ?>
                        <!-- Register Selection -->
                        <?php if($cashRegisters && $cashRegisters->count() > 1): ?>
                        <div class="mb-4">
                            ...
                            <select wire:change="selectRegister($event.target.value)" class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                <!--[if BLOCK]><![endif]--><?php if($cashRegisters): ?>
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $cashRegisters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $register): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($register->id); ?>" <?php echo e($selectedRegister && $selectedRegister->id == $register->id ? 'selected' : ''); ?>>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($selectedRegister): ?>
                        <!-- Current Balance and Actions - Mobile Responsive -->
                        <div class="bg-gray-50 p-4 lg:p-6 rounded-lg mb-6">
                            <div class="flex flex-col lg:flex-row lg:justify-between lg:items-center space-y-4 lg:space-y-0">
                                <div class="text-center lg:text-left">
                                    <h4 class="text-xl font-semibold text-gray-900"><?php echo e($selectedRegister->name); ?></h4>
                                    <!--[if BLOCK]><![endif]--><?php if($selectedRegister->description): ?>
                                        <p class="text-sm text-gray-600 mt-1"><?php echo e($selectedRegister->description); ?></p>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    <p class="text-2xl lg:text-3xl font-bold text-green-600 mt-2"><?php echo e(\App\Helpers\Settings::formatPrice($selectedRegister->balance)); ?></p>
                                </div>
                                <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
                                    ...
                                    <?php if($cashRegisters && $cashRegisters->count() > 1): ?>
                                    <button wire:click="showDeleteRegisterModalAction(<?php echo e($selectedRegister->id); ?>)" class="w-full sm:w-auto bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded text-sm">
                                        Удалить кассу
                                    </button>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </div>
                            ...
                            <div class="flex space-x-1 bg-gray-100 rounded-lg p-1">
                                <button 
                                    ...
                                    class="px-3 py-1 text-sm font-medium rounded-md transition-colors duration-200 flex items-center space-x-1
                                        <?php echo e($transactionTypeFilter === 'all' ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-600 hover:text-gray-900'); ?>">
                                ...
                                <button 
                                    ...
                                    class="px-3 py-1 text-sm font-medium rounded-md transition-colors duration-200 flex items-center space-x-1
                                        <?php echo e($transactionTypeFilter === 'money_only' ? 'bg-white text-blue-700 shadow-sm' : 'text-gray-600 hover:text-blue-600'); ?>">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <button 
                                    ...
                                    class="px-3 py-1 text-sm font-medium rounded-md transition-colors duration-200 flex items-center space-x-1
                                        <?php echo e($transactionTypeFilter === 'income' ? 'bg-white text-green-700 shadow-sm' : 'text-gray-600 hover:text-green-600'); ?>">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <button 
                                    ...
                                    class="px-3 py-1 text-sm font-medium rounded-md transition-colors duration-200 flex items-center space-x-1
                                        <?php echo e($transactionTypeFilter === 'expense' ? 'bg-white text-red-700 shadow-sm' : 'text-gray-600 hover:text-red-600'); ?>">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            <?php echo e(\App\Helpers\Settings::formatDateTime($transaction->created_at)); ?>

                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium 
                                                <?php echo e($transaction->type === 'income' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                                <?php echo e($transaction->type === 'income' ? 'Приход' : 'Расход'); ?>

                                            </span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium 
                                            <?php echo e($transaction->type === 'income' ? 'text-green-600' : 'text-red-600'); ?>">
                                            <?php echo e($transaction->type === 'income' ? '+' : '-'); ?><?php echo e(\App\Helpers\Settings::formatPrice($transaction->amount)); ?>

                                        </td>
                                        <td class="px-6 py-4 text-sm text-gray-900">
                                            <?php echo e($transaction->description); ?>

                                            <!--[if BLOCK]><![endif]--><?php if($transaction->operation): ?>
                                                <br><small class="text-gray-500">Операция: <?php echo e($transaction->operation->operation_number); ?></small>
                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            <?php echo e($transaction->user ? $transaction->user->name : 'Пользователь не найден (ID: ' . $transaction->user_id . ')'); ?>

                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            <?php echo e(\App\Helpers\Settings::formatPrice($transaction->balance_after)); ?>
                            ...
                            <div class="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                                <div class="flex justify-between items-start mb-3">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-sm font-medium text-gray-900"><?php echo e(\App\Helpers\Settings::formatPrice($transaction->balance_after)); ?></p>
                                    </div>
                                </div>
                                
                                <div class="border-t border-gray-100 pt-3">
                                    <p class="text-sm text-gray-900 mb-2"><?php echo e($transaction->description); ?></p>
                                    <!--[if BLOCK]><![endif]--><?php if($transaction->operation): ?>
                                        <p class="text-xs text-gray-500 mb-1">Операция: <?php echo e($transaction->operation->operation_number); ?></p>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    <p class="text-xs text-gray-500">
                                        Пользователь: <?php echo e($transaction->user ? $transaction->user->name : 'Не найден (ID: ' . $transaction->user_id . ')'); ?>
    ...
    <!-- Add Money Modal -->
    <!--[if BLOCK]><![endif]--><?php if($showAddMoneyModal): ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <!--[if BLOCK]><![endif]--><?php if($showWithdrawMoneyModal): ?>
    <div class="fixed z-50 inset-0 overflow-y-auto">
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            <div class="fixed inset-0 transition-opacity">
                <div class="absolute inset-0 bg-gray-500 opacity-75"></div>
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <div class="mb-4 p-3 bg-yellow-50 border border-yellow-200 rounded">
                            <p class="text-sm text-yellow-800">
                                Доступно в кассе: <strong><?php echo e(\App\Helpers\Settings::formatPrice($selectedRegister ? $selectedRegister->balance : 0)); ?></strong>
                            </p>
                        </div>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <!--[if BLOCK]><![endif]--><?php if($showCreateRegisterModal): ?>
    <div class="fixed z-50 inset-0 overflow-y-auto">
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            <div class="fixed inset-0 transition-opacity">
                <div class="absolute inset-0 bg-gray-500 opacity-75"></div>
                ...
                <form wire:submit.prevent="createRegister">
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['registerName'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="mb-4">
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['registerDescription'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <!--[if BLOCK]><![endif]--><?php if($showDeleteRegisterModal && $registerToDelete): ?>
    <div class="fixed z-50 inset-0 overflow-y-auto">
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            <div class="fixed inset-0 transition-opacity">
                <div class="absolute inset-0 bg-gray-500 opacity-75"></div>
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">
                                    Вы уверены, что хотите удалить кассу "<strong><?php echo e($registerToDelete->name); ?></strong>"?
                                </p>
                                <!--[if BLOCK]><![endif]--><?php if($registerToDelete->balance != 0): ?>
                                <p class="text-sm text-red-600 mt-2">
                                    <strong>Внимание:</strong> В кассе остается <?php echo e(\App\Helpers\Settings::formatPrice($registerToDelete->balance)); ?>
...
<?php /**PATH H:\OSPanel\home\crm-starter.kit\resources\views/livewire/admin/cash-register-manager.blade.php ENDPATH**/ ?>