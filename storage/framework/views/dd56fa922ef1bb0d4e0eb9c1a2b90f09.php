...
<?php endif; ?>
<?php $component->withAttributes(['size' => 'xl']); ?>Управление разделами <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <div class="mb-6 flex justify-between items-center">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sections.create')): ?>
                ...
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center space-x-3">
                                <!--[if BLOCK]><![endif]--><?php if($section->icon): ?>
                                ...
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                <div>
                                        <div class="font-medium text-gray-900"><?php echo e($section->display_name); ?></div>
                                        <div class="text-sm text-gray-500"><?php echo e($section->name); ?></div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <code class="text-sm bg-gray-100 px-2 py-1 rounded text-gray-800"><?php echo e($section->name); ?></code>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="max-w-xs truncate text-gray-900" title="<?php echo e($section->description); ?>">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">
                                    <?php echo e($section->permissions_count); ?>

                                </span>
                        </td>
                            <td class="px-6 py-4 whitespace-nowrap text-gray-900"><?php echo e($section->sort_order); ?></td>
                        <td class="px-6 py-4 whitespace-nowrap">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sections.edit')): ?>
                                    <button wire:click="toggleStatus(<?php echo e($section->id); ?>)" 
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($section->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'); ?>">
                                        <?php echo e($section->is_active ? 'Активен' : 'Неактивен'); ?>

                                    </button>
                                <?php else: ?>
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($section->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'); ?>">
                                        <?php echo e($section->is_active ? 'Активен' : 'Неактивен'); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <div class="flex items-center justify-center space-x-2">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sections.edit')): ?>
                                        <button wire:click="edit(<?php echo e($section->id); ?>)" class="inline-flex items-center justify-center w-8 h-8 rounded-full text-blue-600 bg-blue-100 hover:bg-blue-200 transition-colors duration-150" title="Редактировать">
                                            <svg class="h-4 w-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                            </svg>
                                        </button>
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sections.delete')): ?>
                                        <button 
                                            wire:click="delete(<?php echo e($section->id); ?>)" 
                                            class="inline-flex items-center justify-center w-8 h-8 rounded-full text-red-600 bg-red-100 hover:bg-red-200 <?php echo e($section->permissions_count > 0 ? 'opacity-50 cursor-not-allowed' : ''); ?>"
                                            wire:confirm="Вы уверены, что хотите удалить этот раздел?"
                                            <?php echo e($section->permissions_count > 0 ? 'disabled' : ''); ?>
                    ...
                    <div class="grid grid-cols-4 gap-4 items-center">
                        <div>
                            <div class="flex items-center space-x-2">
                                ...
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                <div>
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($section->display_name); ?></div>
                                    <div class="text-xs text-gray-500"><?php echo e($section->name); ?></div>
                                </div>
                            </div>
                            <div class="text-xs text-gray-500 mt-1 truncate max-w-xs" title="<?php echo e($section->description); ?>">
                                <?php echo e($section->description); ?>
                        ...
                        <div>
                            ...
                            <div class="text-xs text-gray-500 mt-1">Порядок: <?php echo e($section->sort_order); ?></div>
                        </div>
                        <div>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sections.edit')): ?>
                                <button wire:click="toggleStatus(<?php echo e($section->id); ?>)" 
                                    class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium <?php echo e($section->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'); ?>">
                                    <?php echo e($section->is_active ? 'Активен' : 'Неактивен'); ?>

                                </button>
                            <?php else: ?>
                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium <?php echo e($section->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'); ?>">
                                    <?php echo e($section->is_active ? 'Активен' : 'Неактивен'); ?>
                        ...
                        <div class="text-center">
                            <div class="flex items-center justify-center space-x-1">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sections.edit')): ?>
                                    <button wire:click="edit(<?php echo e($section->id); ?>)" class="inline-flex items-center justify-center w-7 h-7 rounded-full text-blue-600 bg-blue-100 hover:bg-blue-200" title="Редактировать">
                                        <svg class="h-4 w-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                        </svg>
                                    </button>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sections.delete')): ?>
                                    <button 
                                        wire:click="delete(<?php echo e($section->id); ?>)" 
                                        class="inline-flex items-center justify-center w-7 h-7 rounded-full text-red-600 bg-red-100 hover:bg-red-200 <?php echo e($section->permissions_count > 0 ? 'opacity-50 cursor-not-allowed' : ''); ?>"
                                        wire:confirm="Вы уверены, что хотите удалить этот раздел?"
                                        <?php echo e($section->permissions_count > 0 ? 'disabled' : ''); ?>
            ...
            <div class="divide-y divide-gray-200">
                ...
                <div class="p-4 space-y-3">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-2">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sections.edit')): ?>
                                <button wire:click="edit(<?php echo e($section->id); ?>)" class="inline-flex items-center justify-center w-8 h-8 rounded-full text-blue-600 bg-blue-100 hover:bg-blue-200" title="Редактировать">
                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                    </svg>
                                </button>
                    ...
                    <div class="grid grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                            ...
                            <span class="font-medium text-gray-900"><?php echo e($section->sort_order); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        <div>
                            <h3 class="text-lg font-medium leading-6 text-gray-900 dark:text-gray-100">
                                <?php echo e($editingSection ? 'Редактировать раздел' : 'Создать раздел'); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="flex justify-end space-x-3">
                            ...
                            <button type="submit" 
                                class="px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                <?php echo e($editingSection ? 'Обновить' : 'Создать'); ?>
...
<?php /**PATH H:\OSPanel\home\crm-starter.kit\resources\views/livewire/admin/sections/section-manager.blade.php ENDPATH**/ ?>