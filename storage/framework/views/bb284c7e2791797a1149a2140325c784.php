                ...
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-800">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="font-medium text-gray-900 dark:text-gray-100"><?php echo e($role->name); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-200">
                                <?php echo e($role->permissions_count); ?>
                                                        ...
                                                        <td class="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-gray-100"><?php echo e(\App\Helpers\Settings::formatDateTime($role->created_at)); ?></td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('roles.edit')): ?>
                                    <button wire:click="edit(<?php echo e($role->id); ?>)" class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300">
                                        Редактировать
                                    </button>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('roles.delete')): ?>
                                    <button 
                                        ...
                                        class="text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-300 <?php echo e(($role->users_count > 0 && !auth()->user()->isSuperAdmin()) ? 'opacity-50 cursor-not-allowed' : ''); ?>"
                                        wire:confirm="Вы уверены, что хотите удалить эту роль?"
                                        <?php echo e(($role->users_count > 0 && !auth()->user()->isSuperAdmin()) ? 'disabled' : ''); ?>
            ...
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="border-b border-gray-200 dark:border-gray-700 p-4 hover:bg-gray-50 dark:hover:bg-gray-800">
                    ...
                    <div class="flex items-center justify-between mb-3">
                        <div class="flex-1">
                            <h3 class="font-medium text-gray-900 dark:text-gray-100"><?php echo e($role->name); ?></h3>
                            <div class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                Создана: <?php echo e(\App\Helpers\Settings::formatDate($role->created_at)); ?>
                    ...
                    <div class="flex items-center justify-end space-x-3 pt-2 border-t border-gray-100 dark:border-gray-600">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('roles.edit')): ?>
                            <button wire:click="edit(<?php echo e($role->id); ?>)" class="text-sm text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300">
                                Редактировать
                            </button>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('roles.delete')): ?>
                            <button 
                                wire:click="delete(<?php echo e($role->id); ?>)" 
                                class="text-sm text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-300 <?php echo e(($role->users_count > 0 && !auth()->user()->isSuperAdmin()) ? 'opacity-50 cursor-not-allowed' : ''); ?>"
                                wire:confirm="Вы уверены, что хотите удалить эту роль?"
                                <?php echo e(($role->users_count > 0 && !auth()->user()->isSuperAdmin()) ? 'disabled' : ''); ?>
...
<?php /**PATH H:\OSPanel\home\crm-starter.kit\resources\views/livewire/admin/roles/role-manager.blade.php ENDPATH**/ ?>