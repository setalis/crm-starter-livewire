                                            ...
                                            <div class="mt-2 grid grid-cols-1 md:grid-cols-4 gap-4">
                                                ...
                                                <div>
                                                    <label class="text-sm flex items-center justify-between">
                                                        ...
                                                        @if($item['type'] === 'simple')
                                                            @if(isset($item['custom_price_set']) && $item['custom_price_set'])
                                                    ...
                                                    <div class="flex">
                                                        <input type="number" 
                                                               ...
                                                               onfocus="this.select(); @this.startEditingPrice({{ $index }})"
                                                               onblur="@this.stopEditingPrice({{ $index }})"
                                                               placeholder="Введите цену">
                                                        @if($item['type'] === 'simple' && isset($item['custom_price_set']) && $item['custom_price_set'])
                                                            <button type="button" 
                                                                    wire:click="resetPriceToAuto({{ $index }})"
                                            ...
                                            <div class="mt-4 border-t pt-2">
                                                ...
                                                <div class="mt-3 p-3 bg-blue-50 rounded border-l-4 border-blue-400">
                                                    ...
                                                    <div class="flex justify-between items-center mt-1">
                                                        ...
                                                        <span class="text-sm font-bold text-green-600">{{ \App\Helpers\Settings::formatPrice($pricePerKg * (float)($item['weight'] ?? 0)) }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            @endif
