...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="flex min-h-screen bg-white dark:bg-zinc-800">
        ...
        <div class="flex flex-1 flex-col">
            ...
            <flux:header class="hidden lg:block bg-white lg:bg-zinc-50 dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-700 shadow-sm">
                <flux:navbar>
                    <!-- Быстрые действия слева -->
                    <flux:navbar.item :href="route('admin.operations.create', 'purchase')" icon="plus" badge="Покупка" badge-color="green" wire:navigate>
                        {{ __('Быстрая покупка') }}
                    </flux:navbar.item>
                    <flux:navbar.item :href="route('admin.operations.create', 'sale')" icon="arrow-up-right" badge="Продажа" badge-color="blue" wire:navigate>
                        {{ __('Быстрая продажа') }}
                    </flux:navbar.item>
